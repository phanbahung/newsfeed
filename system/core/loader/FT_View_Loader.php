...
class FT_View_Loader
{
     ...
     * @param   string
     * @param   array
     * @desc    hàm load view, tham số truyền vào là tên của layout và dữ liệu (trong đó có tên view) truyền qua layout
     */
    public function load($layout, $data = array()) 
    {
        ...
        require_once PATH_APPLICATION . '/view/' . $layout . '.php';
