...
<html lang="zxx" class="no-js">
	<head>
		...
		CSS
		============================================= -->
		<link rel="stylesheet" href="assets/frontend/css/linearicons.css">
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
							<a href="index.html">
								<img class="img-fluid" src="assets/frontend/img/logo.png" alt="">
							</a>
						</div>
			...
			<div class="container main-menu" id="main-menu">
				<div class="row align-items-center justify-content-between">
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							<li class="menu-active"><a href="index.php?c=home">Trang chủ</a></li>
							<li class="menu-has-children"><a href="">Danh mục chủ đề</a>
							<ul>
						...
						<li><a href="about.html">Hệ thống</a></li>
						<li><a href="about.html">Office</a></li>
						<li><a href="about.html">TMS</a></li>
					...
					<div class="row small-gutters">
						<div class="col-lg-8 top-post-left">
							<div class="feature-image-thumb relative">
								...
								<img class="img-fluid" src="assets/frontend/img/top-post1.jpg" alt="">
							</div>
						...
						<div class="col-lg-4 top-post-right">
							<div class="single-top-post">
								<div class="feature-image-thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="assets/frontend/img/top-post2.jpg" alt="">
								</div>
								<div class="top-post-details">
									<ul class="tags">
										<li><a href="#">Food Habit</a></li>
							...
							<div class="single-top-post mt-10">
								<div class="feature-image-thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="assets/frontend/img/top-post3.jpg" alt="">
								</div>
								<div class="top-post-details">
									<ul class="tags">
										<li><a href="#">Food Habit</a></li>
			...
			<section class="latest-post-area pb-120">
				<div class="container no-padding">
					<div class="row">
						...
						<!-- Start sidebars-area -->
							<?php
								include("websites/view/shared/sidebar.php");
							?>
						<!-- End sidebars-area -->	
						</div>
					</div>  <!-- End row -->
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-2 col-md-6 single-footer-widget">
						...
						<ul>
							<li><a href="#">Jobs</a></li>
							<li><a href="#">Brand assets/frontend</a></li>
